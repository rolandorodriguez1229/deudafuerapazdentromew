...
export const metadata: Metadata = {
  ...
  description:
    'Cuando estás ahogado, recuperar flujo mensual vence a optimizar intereses. Te muestro cuándo conviene cambiar de estrategia.',
  alternates: { canonical: '/blog/flujo-vs-intereses' },
};
